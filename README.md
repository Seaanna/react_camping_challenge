# Hipcamp Technical Exercise

Using React, Css, Bootstrap, and Material UI I created a component to reveal the levels of features
based on the the sample JSON structure.

Main focus is to complete challenge in React,
indicate features in a special way,
and to make it look great.
(I added a little more than requested from the challenge)
